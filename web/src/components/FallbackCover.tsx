...
// The idle cover state is a monochrome liquid-glass plate — matches the
// rest of the UI (no colorful gradients ever).
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(closest-side at 30% 25%, var(--fg) 0%, transparent 70%), radial-gradient(closest-side at 75% 70%, var(--fg) 0%, transparent 70%)',
        }}
      />
